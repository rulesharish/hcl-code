...
public class AccountsController {
  ...
  public ResponseEntity<Object> initTransfer(@RequestBody @Valid Transfer transaction) {
    log.info("Initiating  Transfer {}", transaction);

    try {
    this.accountsService.InitiateTransfer(transaction);
